      ...
      <header className={`${scrolling ? 'border-b border-gray-900' : ''}  fixed left-0 right-0 top-0 z-20`} id="home">
        <div className="container m-auto px-4 py-6 max-w-4xl bg-black">
          <div className="flex flex-col gap-4 sm:flex-row justify-between items-center">
            <div>
              <h1 className="font-bold text-2xl">Chitransh Portfolio</h1>
            </div>
            <div>
      ...
      <main className="relative mt-28">
        ...
        <section>
          <div className="container m-auto px-4 pt-12 pb-12 sm:pt-20 flex flex-col sm:flex-row gap-6 text-center sm:text-left">
            <div>
              <h2 className="font-bold text-4xl">Hello, I'm Chitransh Sinha,</h2>
              <div>
                <h2 className="font-bold text-4xl mt-1 gradiant-text">a Web Developer</h2>
              </div>
              <div>
                <p className="mt-4 text-gray-400">
                I'm a versatile web developer with a passion for clean code and elegant design, crafting digital experiences that captivate and inspire.
                </p>
          ...
          <div className="container m-auto px-4 sm:py-12">
            ...
            <div className="flex flex-col sm:flex-row gap-10 mt-11">
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  <strong>A comprehensive website for yoga enthusiast.</strong> 
                </p>
                <p className="text-gray-400 text-sm mt-2">
                Technologies Used: HTML, CSS, JavaScript, Nodejs, MongoDB, Expressjs
                </p>
              ...
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  <strong>A Website in which one can book cars for a certain period of time.</strong> 
                </p>
                <p className="text-gray-400 text-sm mt-2">
            ...
            <div className="flex flex-col sm:flex-row  gap-10 mt-11">
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  <strong>A web-based AI-powered question-answering system using OpenAI API.</strong> 
                </p>
                <p className="text-gray-400 text-sm mt-2">
                Technologies Used: React.js, Vite.js, Tailwind CSS, Node.js
                </p>
              ...
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  <strong>A Google Chrome Extension that tells random Dad Jokes by calling icanhazdadjoke API.</strong> 
                </p>
                <p className="text-gray-400 text-sm mt-2">
          ...
          <div className="container m-auto px-4">
            ...
            <div className="mt-14">
              ...
              <div className="mt-8">
                ...
                <span className="w-[82%] h-2 mt-2 bg-gradient-to-t from-blue-500 to-cyan-500 block rounded-md" />
              </div>
              <div className="mt-8">
                <div className="flex justify-between items-center">
          ...
          <div className="container m-auto px-4">
            ...
            <div className="mt-12 relative before:absolute before:top-0 before:left-16 before:rounded-full before:bottom-10 sm:before:bottom-2 before:w-1 before:bg-white">
              <div className="pl-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                <h3 className="absolute left-0  font-semibold">2020-24 </h3>
                <p>
                  Persuing B.E from Dayananda Sagar College of Engineering.
                </p>
                <strong>CGPA - 8.81 (as of now)</strong>
              </div>
              <div className="pl-24 mt-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                <h3 className="absolute left-0 text-lg font-semibold">2019</h3>
                <p>
                  Did 12th from LB Shastri School, New Delhi.
                  
                </p>
                <strong>Percentage - 80.8%</strong>
              </div>
              <div className="pl-24 mt-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                <h3 className="absolute left-0 text-lg font-semibold">2017</h3>
                <p>
                  Did 10th from St. Aloysius School, Jabalpur. 
